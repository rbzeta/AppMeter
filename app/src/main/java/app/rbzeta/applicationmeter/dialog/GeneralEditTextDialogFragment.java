...
public class GeneralEditTextDialogFragment extends DialogFragment implements View.OnClickListener{

    private String mTitle,mHint,mValue,mTextType,mInputType;
    private EditText editTextInput;

    public GeneralEditTextDialogFragment() {
        super();
    }

    public static GeneralEditTextDialogFragment newInstance(String title, String hint, String value
            ,String textType,String inputType){
        GeneralEditTextDialogFragment fragment = new GeneralEditTextDialogFragment();
